  ...
  return (
    <div>
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="w-full flex items-center justify-center gap-2 rounded-md border border-black/10 dark:border-white/15 py-2 text-sm font-medium hover:bg-black/5 dark:hover:bg-white/10 disabled:opacity-50"
      >
        <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
          ...
          <path
            fill="#4CAF50"
            d="M24 44c5.5 0 10.4-2.1 14.2-5.5l-6.6-5.4C29.6 34.9 27 36 24 36c-5.2 0-9.6-3.4-11.2-8.1l-6.6 5.1C9.9 39.6 16.4 44 24 44z"
          />
          <path
            fill="#1976D2"
            d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4.1 5.6l6.6 5.4C41.5 35.9 44 30.5 44 24c0-1.3-.1-2.7-.4-3.5z"
          />
        </svg>
